# Testing: Harry Potter API

_This is a challenge from testing, specialized in frontend develop, application where the Harry Potter API is consumed and applied._

## [Try the live demo](https://romerojoseing.github.io/harry-potter-api/) ⚡
...
```ssh
  $ git clone https://github.com/romerojoseing/harry-potter-api.git
```
